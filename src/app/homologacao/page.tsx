...
const ITEMS: Item[] = [
  ...
  },
  {
    ...
    desc: 'Campo de frete do cliente deve aceitar tanto percentual (%) quanto valor fixo (R$). Futuramente puxar do cadastro do produto por volume/cubagem.',
    status: 'progress',
    tag: 'Planejamento',
  },
  {
    ...
    desc: 'Adicionar status intermediário entre EM_PATIO e EM_TRANSITO — caminhão carregado mas ainda no pátio aguardando saída.',
    status: 'pending',
    tag: 'Status',
  },
  {
    ...
    desc: 'Campo para registrar onde cada motorista está a cada dia. Clientes ligam para saber previsão de entrega; responsável registra diariamente.',
    status: 'pending',
    tag: 'Entregas',
  },
  {
    id: 14,
    title: 'Cadastro de Produtos — Preço por volume',
    desc: 'Cada volume do produto precisa ter preço unitário para calcular automaticamente o % do frete na tela de planejamento e coleta.',
    status: 'pending',
    tag: 'Produtos',
  },
  {
    ...
    desc: 'Upload de CNH e outros documentos do motorista com alerta automático de vencimento próximo.',
    status: 'pending',
    tag: 'Motoristas',
  },
  {
    ...
    desc: 'Toda coleta deve estar vinculada a uma Nota Fiscal e a pelo menos um produto cadastrado.',
    status: 'pending',
    tag: 'Coletas',
  },
  {
    ...
    desc: 'Mostrar claramente de onde sai e para onde vai. Campo de localização diária do motorista integrado à tela de operação.',
    status: 'pending',
    tag: 'Operação',
  },
  {
    ...
    desc: 'Relatório completo por cliente: tempo de cada coleta, valor, itens, de forma clara e organizada para envio direto ao cliente (ex: CEQUIP).',
    status: 'pending',
    tag: 'Relatórios',
  },
  {
